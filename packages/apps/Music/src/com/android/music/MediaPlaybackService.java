...
public class MediaPlaybackService extends Service {
    ...
    private Handler mMediaplayerHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.v(LOGTAG, "mMediaplayerHandler.handleMessage"+ msg.what);
            switch (msg.what) {
              case FADEDOWN: 
			  Log.v(LOGTAG, "mCurrentVolume"+ mCurrentVolume);
			 mCurrentVolume -= .05f;
    ...
    public void onCreate() {
    	...
    	//Add By Michael.Chan Apr.15 2013   Music Play State switch by different PhoneState begin
	 mTelephonyManager =
                (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
         
        mTelephonyManager.listen(
                mPhoneStateListener, PhoneStateListener.LISTEN_CALL_STATE);
    	//Add By Michael.Chan Apr.15 2013   Music Play State switch by different PhoneState end
...
//        mRemoteControlClient.setTransportControlFlags(flags);
	...
	//Add By Michael.Chan Apr.16 2013   Stop listening for incoming calls.
        ...
        if (mUnmountReceiver == null) {
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    } else if (action.equals(Intent.ACTION_MEDIA_MOUNTED) || action.equals(ACTION_MEDIA_SCANNER_SCAN_AUDIO)) {
                        mMediaMountedCount++;
            ...
            iFilter.addAction(ACTION_MEDIA_SCANNER_SCAN_AUDIO);
...
//            ed.putString(MediaMetadataRetriever.METADATA_KEY_DISPLAY_NAME, getTrackName());
...
//            ed.apply();
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            mPlayer.start();
 //Add By chenlongxin Apr.25 2013   Music Play State switch by different PhoneState begin
...
//Add By chenlongxin Apr.25 2013	Music Play State switch by different PhoneState end
