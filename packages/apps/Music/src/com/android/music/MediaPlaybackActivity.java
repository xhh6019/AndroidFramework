    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (MusicUtils.getCurrentAudioId() >= 0) {
            ...
            if (TelephonyManager.getDefault().isMultiSimEnabled()) {
                ...
                int[] menuStrings = { R.string.ringtone_menu_short_1,
                                      R.string.ringtone_menu_short_2 };
...
*/
    ...
    private long refreshNow() {
        ...
        // refresh once every 500ms for blink effect and guarantee progress bar
        // will get updated at the last second
        return 500;
    }
