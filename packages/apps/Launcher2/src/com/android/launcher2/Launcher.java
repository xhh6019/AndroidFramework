...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!FeatureQuery.FEATURE_LAUNCHER_SEARCH_BOX) {
            //if do not show search box, set invisible
            searchVisible = false;
            voiceVisible = false;
        }
...
//        }
	...
	//hide the workspace items on hide AppsLayout.add by ouyang@2013.6.7.
...
//                        updateWallpaperVisibility(false);
	...
	//show the workspace items on hide AppsLayout.add by ouyang@2013.6.7.
    ...
    private boolean updateGlobalSearchIcon() {
        ...
        if (FeatureQuery.FEATURE_LAUNCHER_SEARCH_BOX && activityName != null) {
            int coi = getCurrentOrientationIndexForGlobalIcons();
