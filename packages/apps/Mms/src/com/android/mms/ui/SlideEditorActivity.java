...
public class SlideEditorActivity extends Activity {
    ...
    private final static int MENU_ADD_MUSIC       = 15;
    ...
    private final static int  REQUEST_CODE_ATTACH_MUSIC  = 8;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (slide.hasAudio()) {
		  ...
		  //subMenu.add(0, MENU_ADD_MUSIC, 0, R.string.attach_music);
		  ...
		  break;
            ...
            case MENU_RECORD_SOUND:
                ...
                long sizeLimit = ComposeMessageActivity.computeAttachmentSizeLimit(mSlideshowModel,
                        currentSlideSize);
		  /*judgesize is use to refuse the situation like record maxtime <1  */
		  long judgesize= (sizeLimit - 1606)/1600;
		  if(judgesize>0){
                MessageUtils.recordSound(this, REQUEST_CODE_RECORD_SOUND, sizeLimit);
		  	}else{
			  Toast.makeText(this,
					  getString(R.string.message_too_big_for_audio),
					  Toast.LENGTH_SHORT).show();
		  	}
                break;
