...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    private void ManageSimPref(){
	if(TelephonyManager.getDefault().isMultiSimEnabled() ){
		mManageSimPref.setSummary(R.string.pref_summary_manage_sim_uim_messages);
		mManageSimPref.setTitle(R.string.pref_title_manage_sim_uim_messages);
		}else{
		mManageSimPref.setSummary(R.string.pref_summary_manage_uim_messages);
		mManageSimPref.setTitle(R.string.pref_title_manage_uim_messages);
		}
    	}
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mSmsLimitPref) {
            ...
            if (!TelephonyManager.getDefault().isMultiSimEnabled() || hasIccCardCount() <= 1) {
            ...
            if (!TelephonyManager.getDefault().isMultiSimEnabled()) {
                ...
                Intent intent = new Intent(this, SelectSubscription.class);
                intent.putExtra(SelectSubscription.PACKAGE, "com.android.mms");
                intent.putExtra(SelectSubscription.TARGET_CLASS, "com.android.mms.ui.GsmUmtsCellBroadcastSms");
                startActivity(intent);
            }
