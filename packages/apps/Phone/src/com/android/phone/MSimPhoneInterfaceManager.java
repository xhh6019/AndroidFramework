...
public class MSimPhoneInterfaceManager extends ITelephonyMSim.Stub {
    ...
    public void modemSwitch()    //wuyixin modify here for modemswitch
    {
     Log.d(LOG_TAG, "modemSwitch");
     ((MSimPhoneApp)mApp).modemSwitch();
    	return;
    }

    /* luxx@20130513 modify here for modem USB connect with PC for debug log or calibration */
    public void modemCalibrate()
    {
     Log.d(LOG_TAG, "modemCalibrate");
     ((MSimPhoneApp)mApp).modemCalibrate();
    	return;
    }
    ...
    //wuyixin modify here for get cdma min 
    public String getCdmaMin()
    {
    	    int subscription = 1;   //slot2
    	    return getPhone(subscription).getCdmaMin();
    }
    //wuyixin modify here for modemPowerDown
    public void modemPowerDown()
    {
    	   int subscription = 1;   //slot2
        Log.w(LOG_TAG, "MsimPhoneInteerfaceManager modemPowerDown");        
    	   getPhone(subscription).modemPowerDown();
    	   return;
    }
}
