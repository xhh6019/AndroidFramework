            ...
            case PHONE_INCOMING_RING:
                ...
                if (msg.obj != null && ((AsyncResult) msg.obj).result != null) {
                    ...
                    if ((pb.getState() == Phone.State.RINGING)
                        ...
                        if(mCallerInfoQueryState == CALLERINFO_QUERY_READY)   //wuyixin modify here for sometimes incoming call use default ringtone.
                        {
                              mRinger.ring();
                        }
			   else
		   	  {
		   		if (DBG) log("mCallerInfoQueryState is QUERYING,just wait complete event");
		   	  }
                    } else {
