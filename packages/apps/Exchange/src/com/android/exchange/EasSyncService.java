                ...
                if (!resp.isEmpty()) {
                    ...
                    try {
                        if (parser.getStatusCode() == FetchMessageParser.STATUS_CODE_SUCCESS) {
                            ...
                            ExchangeService.callback().loadMoreStatus(msg.mId, EmailServiceStatus.SUCCESS, 100);
                        } else {
                            ExchangeService.callback().loadMoreStatus(msg.mId, EmailServiceStatus.CONNECTION_ERROR, 100);
                        }
