...
public class ActivityMusic extends Activity implements OnSeekBarChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        for (short i = 0; i < numPresets; i++) {
            ...
            } else if (presetName.equals("Flat")) {
                mEQPresetNames[i] = getString(R.string.flat);
            } else if (presetName.equals("Folk")) {
                mEQPresetNames[i] = getString(R.string.folk);
            } else if (presetName.equals("Heavy Metal")) {
                mEQPresetNames[i] = getString(R.string.heavy_metal);
            } else if (presetName.equals("Hip Hop")) {
                mEQPresetNames[i] = getString(R.string.hip_hop);
            } else if (presetName.equals("Jazz")) {
