...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
	 ...
	 // Show LockTitle
	 Preference iccLockTitle = (Preference) root.findPreference(KEY_SIM_LOCK);
	 iccLockTitle.setTitle(setSimUimString(R.string.sim_lock_settings_title));
	 ...
	 iccLock.setTitle(setSimUimString(R.string.sim_lock_settings));
    ...
    private String setSimUimString(int id){
		...
		//return SimUimString[0]+"SIM/UIM"+SimUimString[1]  ;
		   return "UIM/"+SimString;   //wuyixin modify here for string array out of range.
		}else{
