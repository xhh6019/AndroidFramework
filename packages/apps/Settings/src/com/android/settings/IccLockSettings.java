...
public class IccLockSettings extends PreferenceActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
	 ...
	 setTitle(setSimUimString(R.string.sim_lock_settings));
	

        mPinDialog = (EditPinPreference) findPreference(PIN_DIALOG);
	 mPinDialog.setTitle(setSimUimString(R.string.sim_pin_change));
        mPinToggle = (CheckBoxPreference) findPreference(PIN_TOGGLE);
	 mPinToggle.setTitle(setSimUimString(R.string.sim_pin_toggle));
    ...
    private String setSimUimString(String SU){
		if(SU.contains("SIM")){
			String[] SimUimString = SU.split("SIM");
			if(TelephonyManager.getDefault().isMultiSimEnabled()){
			return SimUimString[0]+"SIM/UIM"+SimUimString[1]  ;
			}else{
			return SimUimString[0]+"UIM"+SimUimString[1]  ;
    ...
    private void setDialogValues() {
        ...
        switch (mDialogState) {
            case ICC_LOCK_MODE:
                message = setSimUimString(mRes.getString(R.string.sim_enter_pin));
                mPinDialog.setDialogTitle(mToState
                        ? setSimUimString(mRes.getString(R.string.sim_enable_sim_lock))
                        : setSimUimString(mRes.getString(R.string.sim_disable_sim_lock)));
                break;
            case ICC_OLD_MODE:
                message = setSimUimString(mRes.getString(R.string.sim_enter_old));
                mPinDialog.setDialogTitle(setSimUimString(mRes.getString(R.string.sim_change_pin)));
                break;
            case ICC_NEW_MODE:
                message = setSimUimString(mRes.getString(R.string.sim_enter_new));
                mPinDialog.setDialogTitle(setSimUimString(mRes.getString(R.string.sim_change_pin)));
                break;
            case ICC_REENTER_MODE:
                message = setSimUimString(mRes.getString(R.string.sim_reenter_new));
                mPinDialog.setDialogTitle(setSimUimString(mRes.getString(R.string.sim_change_pin)));
                break;
        }
        if (mError != null) {
