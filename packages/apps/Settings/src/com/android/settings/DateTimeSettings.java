...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        initUI();
	// add xhh for CDMA Phone set Auto-Time correctly
	...
	if (TelephonyManager.PHONE_TYPE_CDMA == activePhoneType &&
		...
		Settings.System.putInt(
                    getContentResolver(), Settings.System.AUTO_TIME_ZONE, 1);
                       Log.w("DateTimeSettings", "onSharedPreferenceChanged mTimeZone.setEnabled  autoZoneEnabled = " );
    ...
    private void initUI() {
        ...
        if (currentFormat == null) {
	     Log.i("class DateTimeSettings Mxhh", "currentFormat == null");
            currentFormat = "";	

	// add xhh for init Beijing zone
	if (!Config.FEATURE_THIRDPATRY_APPS_OVERSEAS){
	    Log.i("class DateTimeSettings Mxhh", "FEATURE_THIRDPATRY_APPS_OVERSEAS");

	// add xhh for indentity the firstboot
	    Log.i("class DateTimeSettings Mxhh", "---putString for after a factory reset (or data wipe)---");
	    Settings.System.putString(getContentResolver(),
                    Settings.System.DATE_FORMAT, currentFormat);
        ...
        Log.w("DateTimeSettings", "mTimeZone.setEnabled  autoTimeZoneEnabled = " + autoTimeZoneEnabled);
   ...
   //     }
    ...
    public void updateTimeAndDateDisplay(Context context) {
       ...
       //modify xhh for 12010   Date dummyDate = mDummyDate.getTime();
       Date dummyDate = now.getTime();
	 updatemDateFormatEntries(now);
...
//add xhh for 12010
    private void updatemDateFormatEntries(Calendar cal){   
    String [] dateFormats = getResources().getStringArray(R.array.date_format_values);
        String [] formattedDates = new String[dateFormats.length];
		 String currentFormat = getDateFormat();
        ...
        if (key.equals(KEY_DATE_FORMAT)) {
            ...
            Settings.System.putInt(
                    getContentResolver(), Settings.System.AUTO_TIME_ZONE, autoZoneEnabled ? 1 : 0);
                       Log.w("DateTimeSettings", "onSharedPreferenceChanged mTimeZone.setEnabled  autoZoneEnabled = " + autoZoneEnabled);
    ...
    */
    private void setAutoState(boolean isEnabled, boolean autotimeStatus) {
        ...
        mDatePref.setEnabled(!autotimeStatus);
                           Log.w("DateTimeSettings", "setAutoState mTimeZone.setEnabled  autotimeStatus = " + autotimeStatus);
