...
public class ApnSettings extends PreferenceActivity implements
    ...
    private void fillList() {
		Log.d(TAG, "oem: fillList(): operator "+MSimTelephonyManager.getTelephonyProperty(TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC, mSubscription, "")+"mSubscription"+mSubscription);
        String where = "numeric=\""
                + MSimTelephonyManager.getTelephonyProperty						
                 (TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC, mSubscription, "") //get the operator form icc card@CHENHUO20130228   
		  + "\"";
        ...
        while (!cursor.isAfterLast()) {
            ...
            if (name.contains("ro.")){
                //for china union
                if (ChinaUnionPLMN.equals(MSimTelephonyManager.getTelephonyProperty(TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC, mSubscription, ""))){
