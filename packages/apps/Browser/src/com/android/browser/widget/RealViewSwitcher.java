...
public class RealViewSwitcher extends ViewGroup {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            postInvalidate();
        } else if (mNextScreen != INVALID_SCREEN &&(mNextScreen == (mCurrentScreen-1)|| mNextScreen ==(mCurrentScreen+1))) {
            Log.v(LOGTAG,"mNextScreen ="+mNextScreen+" mCurrentScreen ="+mCurrentScreen);
