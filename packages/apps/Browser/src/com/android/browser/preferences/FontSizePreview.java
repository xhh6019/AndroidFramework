...
public class FontSizePreview extends WebViewPreview {
    ...
    static final String HTML_FORMAT = "<!DOCTYPE html><html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><style type=\"text/css\">p { margin: 1px;}</style><body><p><font size=\"0.5\">%s</font></p><p><font size=\"1.5\">%s</font></p><p><font size=\"2.5\">%s</font></p><p><font size=\"4.5\">%s</font></p><p><font size=\"5\">%s</font></p></body></html>";
