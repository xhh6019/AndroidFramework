...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    //add for CU feature
    private static Context mResPackageCtx;
    ...
    private BrowserSettings(Context context) {
        ...
        //add for CU feature
        try {
            mResPackageCtx = context.createPackageContext(
    ...
    private Runnable mSetup = new Runnable() {
        ...
        public void run() {
            ...
            if (null == mResPackageCtx) {
                ...
                int resID = mResPackageCtx.getResources().getIdentifier(
                        "homepage_base", "string", "com.android.browser.res");
                sFactoryResetUrl = mResPackageCtx.getResources().getString(
                        resID);
            }
    ...
    private void syncSetting(WebSettings settings) {
        ...
        //modify for CU feature, set user agent string.
        String ua = null;
        if (null != mResPackageCtx) {
            ...
            if (resID != 0) {
                ua = mResPackageCtx.getResources().getString(resID);
            }
        } else {
        ...
        Log.i("BrowserSettings", "the usString="+ua);
