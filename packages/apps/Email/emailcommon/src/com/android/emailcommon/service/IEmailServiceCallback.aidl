...
oneway interface IEmailServiceCallback {
    ...
    /**
     * Callback to indicate that a particular message is being synced
     * messageId = the message which need sync entire mail
     * statusCode = 0 for OK, 1 for progress, other codes for error
     * progress = 0 for "start", 1..100 for optional progress reports
     */
     void loadMoreStatus(long messageId, int statusCode, int progress);
