...
outer:
    ...
    private static final int MSG_ACCOUNTS_UPDATE = 1;
    private Handler mAccountsUpdatedHandler = new Handler() {

        @Override
        public void handleMessage(android.os.Message msg) {
            if (msg.what != MSG_ACCOUNTS_UPDATE) return;
    ...
    public void onAccountsUpdated(android.accounts.Account[] accounts) {
        mAccountsUpdatedHandler.sendEmptyMessage(MSG_ACCOUNTS_UPDATE);
    }
}
