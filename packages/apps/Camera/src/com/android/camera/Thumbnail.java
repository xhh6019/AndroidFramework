...
public class Thumbnail {
    ...
    public static final String LAST_ITHUMB_FILENAME = "last_ithumb";
	public static final String LAST_ETHUMB_FILENAME = "last_ethumb";

	public static final String LAST_IVTHUMB_FILENAME = "last_ivthumb";
	public static final String LAST_EVTHUMB_FILENAME = "last_evthumb";
    ...
    //save image internal memory and external memory
	public static Thumbnail gainLastImageThumbnail(ContentResolver resolver) {
        Media image = getLastImageThumbnail(resolver);
	...
	public static Thumbnail gainLastVideoThumbnail(ContentResolver resolver) {
        Media video = getLastVideoThumbnail(resolver);
