...
public class CameraSettings {
    ...
    public static final String KEY_PHONE_MEMORY = "pref_camera_phonemeory_key";
    //play sound or not
    public static final String KEY_PHONE_SOUND = "pref_camera_sound_key";
	...
	//save image internal memory and external memory
	ListPreference storeMemory = group.findPreference(KEY_PHONE_MEMORY);
	//play sound or not
	ListPreference sound = group.findPreference(KEY_PHONE_SOUND);
	...
	//save image internal memory and external memory
	public static int readPreferredStoreMemory(SharedPreferences pref) {
        return Integer.parseInt(pref.getString(KEY_PHONE_MEMORY, "0"));
    }

	public static void writePreferredStoreMemory(SharedPreferences pref,
		    int storeMemory) {
		Editor editor = pref.edit();
		editor.putString(KEY_PHONE_MEMORY, Integer.toString(storeMemory));
		editor.apply();
	}
	//play sound or not
	public static int readPreferredSound(SharedPreferences pref) {
        return Integer.parseInt(pref.getString(KEY_PHONE_SOUND, "0"));
        }

	public static void writePreferredSound(SharedPreferences pref,
		    int sound) {
		Editor editor = pref.edit();
		editor.putString(KEY_PHONE_SOUND, Integer.toString(sound));
		editor.apply();
	}	
}
