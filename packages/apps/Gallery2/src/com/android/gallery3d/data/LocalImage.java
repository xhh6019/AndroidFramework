...
public class LocalImage extends LocalMediaItem {
	...
	try {
		...
		if ((cursor != null) && cursor.moveToNext()) {
			...
			Log.e(TAG, "INDEX_TITLE delete filepath: " + filepath);
    ...
    public MediaDetails getDetails() {
        ...
        if((0!=width)&&(0!=height))
        {
            details.addDetail(MediaDetails.INDEX_WIDTH, Integer.valueOf(width));
            details.addDetail(MediaDetails.INDEX_HEIGHT, Integer.valueOf(height));
        }		
