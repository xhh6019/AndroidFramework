...
public abstract class UserDictionaryToolsList extends Activity
    ...
    protected final int JAPANESE = 1;
    protected final int ENGLISH = 2;
    ...
    @Override protected void onStart() {
        ...
        updateCountTitle(mWordList.size());
        updateWordList();
    }

    private void updateCountTitle(int size){
        int mLanuage = R.string.user_dictionary_list_words_en;
        switch(currentLanguage){
            case ENGLISH:
                mLanuage = R.string.user_dictionary_list_words_en;
                break;
            case JAPANESE:
                mLanuage = R.string.user_dictionary_list_words_ja;
                break;
            default:
                mLanuage = R.string.user_dictionary_list_words_en;
        }
        setTitle(getResources().getString(mLanuage) + "   " + size + "/" + MAX_WORD_COUNT);
    }
